    ...
    <div className="container-xl py-8">
      <div className="flex flex-col gap-8">
        <div>
          ...
          <p className="text-muted">Explore our complete collection of premium products</p>
        </div>
              ...
              {categories.map((cat) => (
                <button
                  ...
                  className={`px-4 py-2 rounded-full capitalize transition-colors ${
                    selectedCategory === cat ? "bg-primary text-white" : "border border-border hover:border-primary"
                  }`}
                >
                  {cat}
                </button>
