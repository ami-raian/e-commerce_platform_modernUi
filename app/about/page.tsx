    ...
    <div className="container-xl py-16">
      <div className="max-w-3xl mx-auto space-y-12">
          ...
          <div className="card">
            ...
            <ul className="space-y-3">
              <li className="flex gap-3">
                ...
                <span className="text-muted">Carefully curated collection of premium products</span>
              </li>
              <li className="flex gap-3">
                <span className="text-primary font-bold">✓</span>
                <span className="text-muted">Fast and reliable shipping worldwide</span>
              </li>
              <li className="flex gap-3">
                <span className="text-primary font-bold">✓</span>
              ...
              <li className="flex gap-3">
                <span className="text-primary font-bold">✓</span>
                <span className="text-muted">Secure and encrypted payments</span>
              </li>
              <li className="flex gap-3">
                <span className="text-primary font-bold">✓</span>
                <span className="text-muted">Easy returns and exchanges</span>
              </li>
            </ul>
          </div>
        ...
        <div className="text-center pt-8 border-t border-border">
          <p className="text-muted mb-6">Ready to explore our collection?</p>
